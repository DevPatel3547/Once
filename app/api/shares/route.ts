...
export async function POST(r:Request){
 ...
 }catch(e){console.error('Share creation failed',e instanceof Error?e.message:'unknown');return fail('Sharing is temporarily unavailable. Your local guide is safe.',503);}
}
