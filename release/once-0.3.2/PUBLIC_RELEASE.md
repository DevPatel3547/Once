...
Store submission and approval: not completed. Publisher registration/access for the approved email is unverified. Genuine product screenshots and recorder demo remain outstanding. Any required registration fee/terms require the owner. No launch posts have been published; existing publishing accounts have not been specified. No real-user metrics are claimed.

The package includes the extension, store submission text, launch drafts, promotional artwork, production checks and integrity hashes. Older 0.3.1 records and STATUS.md blockers are superseded by this document where they conflict.
